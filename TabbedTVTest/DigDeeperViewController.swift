...
class DigDeeperViewController: UIViewController, CurrentSeriesAPIControllerProtocol, UICollectionViewDelegate, UICollectionViewDataSource  {
...
//        }
    ...
    func setUpScreen() {
        ...
        // ******************************************* CHANGE THIS PART!!!  ***********************************************************************************
        guard let tempText = thisSeries.session_digging_deeper?.stringByDecodingXMLEntities() else { return }
...
extension DigDeeperViewController {
