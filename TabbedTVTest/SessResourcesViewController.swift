//
//  SessResourcesViewController.swift
//  TabbedTVTest
//
...
class SessResourcesViewController: UIViewController, CurrentSeriesAPIControllerProtocol, UICollectionViewDelegate, UICollectionViewDataSource  {
    ...
    override func viewDidLoad() {
        ...
        // ******************************************* CHANGE THIS PART!!!  ***********************************************************************************
      //  tabTitleLabel.text = dataStore.titlesArray[4]
...
//        }
    ...
    func setUpScreen() {
        ...
        // ******************************************* CHANGE THIS PART!!!  ***********************************************************************************
        guard let tempText = thisSeries.session_introduction?.stringByDecodingXMLEntities() else { return }
...
extension SessResourcesViewController {
