...
class CreateStoryViewController: UIViewController, CurrentSeriesAPIControllerProtocol, UICollectionViewDelegate, UICollectionViewDataSource  {
...
//        }
    ...
    func setUpScreen() {
        ...
        // ******************************************* CHANGE THIS PART!!!  ***********************************************************************************
        guard let tempText = thisSeries.session_create?.stringByDecodingXMLEntities() else { return }
