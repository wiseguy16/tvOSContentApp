...
class ShareViewController: UIViewController, CurrentSeriesAPIControllerProtocol, UICollectionViewDelegate, UICollectionViewDataSource  {
    ...
    override func viewDidLoad() {
        ...
        // ******************************************* CHANGE THIS PART!!!  ***********************************************************************************
       // tabTitleLabel.text = dataStore.titlesArray[1]
...
//            }
//        }
//        if let selindz = tabBarController?.selectedViewController {
//            if selindz.isKind(of: ShareViewController.self) {
//                goLeftButton.isUserInteractionEnabled = true
...
//        }
    ...
    func setUpScreen() {
        ...
        // ******************************************* CHANGE THIS PART!!!  ***********************************************************************************
        guard let tempText = thisSeries.session_share?.stringByDecodingXMLEntities() else { return }
